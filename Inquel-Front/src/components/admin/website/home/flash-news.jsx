...
class FlashNews extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: "",
            ...
            <>
                ...
                <div className="card-header mb-2">
                    <div className="row align-items-center">
                        <div className="col-6 h5 mb-0">Flash news</div>
