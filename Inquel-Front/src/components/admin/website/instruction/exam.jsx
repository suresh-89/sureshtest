...
class ExamInstruction extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: "",
    ...
    fetchData = () => {
        fetch(`${this.url}/examinstruction/`, {
            method: "GET",
            ...
            .then((result) => {
                if (result.sts === true) {
                    this.setState({
                        data: result.data.exam_instruction || "",
    ...
    handleSave = () => {
        ...
        if (this.state.data !== "") {
            fetch(`${this.url}/examinstruction/`, {
                ...
                headers: this.headers,
                body: JSON.stringify({
                    exam_instruction: this.state.data,
                }),
            })
                .then((res) => res.json())
                .then((result) => {
            ...
            <>
                ...
                <div className="card-header mb-2">
                    <div className="row align-items-center">
                        <div className="col-6 h5 mb-0">Exam Instruction</div>
