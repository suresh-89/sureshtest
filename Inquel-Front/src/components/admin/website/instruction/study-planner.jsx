...
class StudyPlannerInstruction extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: "",
    ...
    fetchData = () => {
        fetch(`${this.url}/plannerinstruction/`, {
            method: "GET",
            ...
            .then((result) => {
                if (result.sts === true) {
                    this.setState({
                        data: result.data.study_planner || "",
            ...
            <>
                ...
                <div className="card-header mb-2">
                    <div className="row align-items-center">
                        <div className="col-6 h5 mb-0">
                            Study planner instruction
                        </div>
...
export default StudyPlannerInstruction;
