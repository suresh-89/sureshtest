...
class HODTermsAndCondition extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: "",
    ...
    fetchData = () => {
        fetch(`${this.url}/conditionhod/`, {
            ...
            .then((result) => {
                if (result.sts === true) {
                    this.setState({
                        data: result.data.condition_hod || "",
            ...
            <>
                ...
                <div className="card-header mb-2">
                    <div className="row align-items-center">
                        <div className="col-6 h5 mb-0">HOD terms and condition</div>
...
export default HODTermsAndCondition;
