...
class Catalog extends React.Component {
    ...
    getPath = () => {
        let path = `${this.url}/subscription/`;

        if (this.state.active_category.code !== "") {
            path += `?category=${this.state.active_category.code}`;
        }
    ...
    handleSearch = (e) => {
        ...
        if (this.state.search_term !== "") {
            this.setState(
                ...
                () => {
                    fetch(
                        `${this.url}/subscription/search/?search_term=${this.state.search_term}`,
                        {
                            headers: this.headers,
                            method: "GET",
                        }
    ...
    loadCategory = () => {
        fetch(`${this.url}/subscription/category/`, {
            headers: this.headers,
            method: "GET",
        })
            .then((res) => res.json())
    ...
    loadSubCategory = (list) => {
        this.setState({
            active_category: list,
            active_sub_category: {
                code: "",
                title: "",
            },
        ...
        if (list.code !== "ALL") {
            fetch(`${this.url}/subscription/category/?category=${list.code}`, {
                headers: this.headers,
                method: "GET",
            })
                .then((res) => res.json())
            ...
            this.setState(
                {
                    active_sub_category: { code: "", title: "" },
                    sub_category: [],
                },
                () => this.loadCourses()
            );
    ...
    loadLevel = (list) => {
        ...
        if (list.code !== "ALL") {
            fetch(
                `${this.url}/subscription/category/?category=${this.state.active_category.code}&sub_category=${list.code}`,
                {
                    headers: this.headers,
                    method: "GET",
                }
                                                                            ...
                                                                            <div className="col-6">
                                                                                {item.added_to_cart ? (
                                                                                    <Link
                                                                                        ...
                                                                                        to="/cart"
                                                                                    >
                                                                                        <button className="btn btn-outline-primary btn-sm btn-block shadow-none">
                                                                                            Added{" "}
                                                                                    ...
                                                                                    <button
                                                                                        className="btn btn-outline-primary btn-sm btn-block shadow-none"
                                                                                        onClick={() => {
